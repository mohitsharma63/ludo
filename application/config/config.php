...
$config['base_url'] = 'http://localhost/ludo/'; // Ensure trailing slash
$config['index_page'] = ''; // Blank for clean URLs
$config['uri_protocol'] = 'REQUEST_URI'; // Common for most servers
$config['url_suffix'] = ''; // Optional: Add .html or other suffix if needed
...
$config['csrf_token_name'] = '_auth_token';
$config['csrf_cookie_name'] = '_auth_cookie';
